...
import com.ibm.emart.zuul.constants.EMartConstants;
import com.ibm.emart.zuul.dto.UserInfo;
import com.ibm.emart.zuul.feign.AuthFeign;
...
public class TokenFilter extends ZuulFilter {
  ...
  public Object run() {
    ...
    LOGGER
        .info("--->>> TokenFilter {},{}", request.getMethod(), request.getRequestURL().toString());
    String token = request.getHeader(EMartConstants.TOKEN_KEY);
    ...
    ResponseEntity<UserInfo> responseEntity = authFeign.checkToken(token);
